...
public class BaseFrame {
	...
	}
	{
		...
		case 50: {
			...
			textField_1.setHorizontalAlignment(0);
			textField_1.setFont(new Font("Dialog", Font.BOLD, 12));
			textField_1.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(0, 0, 0),
		...
		default: {
			...
			textField_2.requestFocus();
			textField_2.setHorizontalAlignment(0);
			textField_2.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(0, 0, 0),
				new Color(0, 0, 0), new Color(0, 0, 0), new Color(0, 0, 0)));
			textField_2.setColumns(10);
	...
	panel.setLayout(new MigLayout("", "[180px,grow][grow]",
		"[grow][33px][][grow][33px][20px,fill][][20px,fill][][20px,fill][][20px,fill][][20px,fill][][grow][grow]"));
