...
public class Visio extends BaseFrame {
	...
	espectroPanel.add(solucaoFieldSet, "cell 0 4,growx");
     ...
     */
    private void addOpcoesFieldSet() {
	opcoesFieldSet = new JPanel();
	espectroPanel.add(opcoesFieldSet, "cell 0 3,growx");
	...
	espectroPanel.add(connectionFieldSet, "cell 0 1 1 2,growx");
	...
	espectroPanel.add(graphicsPanel, "cell 2 0 1 5,grow");
	graphicsPanel.setBackground(new Color(0, 0, 51));
	graphicsPanel.setLayout(new MigLayout("", "0[grow]0", "[grow]0"));
	...
	espectroPanel.add(visioPanel, "cell 1 0 1 5,grow");
	...
	espectroPanel.setLayout(new MigLayout("", "[240px][grow]0[142px:142px:142px]", "[][][][grow][80px:n,grow]"));
	...
	espectroPanel.add(espectroFieldset, "cell 0 0,grow");
	...
	public void run() {
		...
		chart.setPicture();
		chart.setToolTipText("<html>" + "<p><b>Nome:</b> " + chart.getName() + "</p>" + "<p><b>Data:</b> " + new java.util.Date((long) chart.getTimestamp()) + "</p>" + "<p><b>Resolu��o:</b> "
			+ chart.getNumberOfSamples() + "</p>" + "<p><b>Descri��o:</b> " + chart.getDescription() + "</p>" + "</html>");
