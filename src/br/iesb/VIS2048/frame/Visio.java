...
public class Visio {
	...
	jfreechart = ChartFactory.createXYLineChart("", "Counts", collectionName, dataset, PlotOrientation.VERTICAL, true, true, false);
	...
	((XYPlot) jfreechart.getPlot()).getRenderer().setSeriesPaint(0, Color.yellow);
