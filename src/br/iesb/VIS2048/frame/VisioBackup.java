...
//		panel_1.setLayout(new MigLayout("", "0[grow]0", "0[90%,grow]0[10%,grow]0"));
//		
...
//		panel_3.setLayout(new MigLayout("", "[8px][grow]", "[grow]0[grow]0[grow]"));
//		
...
//		chart.setCollectionName(db.getMainDB());
