...
public class Chart extends JToggleButton implements Serializable {
	 ...
	 *            the series
	 */
	public Chart(/* Double[] doubleSeries, */String name, String description,
			int numberOfSamples, long timestamp, XYSeries series) {
		setBorderPainted(false);
		setBackground(new Color(0, 0, 51));
		setBorder(new BevelBorder(BevelBorder.LOWERED,
				new Color(102, 204, 204), new Color(102, 204, 204), Color.CYAN,
				Color.CYAN));
	...
	public class genImage implements Runnable {
		...
		public void run() {
			...
			jfreechart = ChartFactory.createXYLineChart("", "", nome, dataset,
					PlotOrientation.VERTICAL, true, true, false);

			counts = (NumberAxis) ((XYPlot) jfreechart.getPlot())
					.getRangeAxis();
			...
			((XYPlot) jfreechart.getPlot()).setBackgroundPaint(new Color(0, 0,
					51));
			...
			// add(picture);
			setIcon(new ImageIcon(jfreechart.createBufferedImage(640, 480)
					.getScaledInstance(112, 84, 2)));
	...
	public Integer getNumberOfSamples() {
		return numberOfSamples == null ? null : Integer
				.valueOf(numberOfSamples);
	}
