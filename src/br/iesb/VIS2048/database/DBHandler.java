...
public class DBHandler {
	...
	public boolean insert(DBChartCollection col) {
		...
		String name = col.count() + "-" + col.getChart(0).getTimestamp() + "-" + col.getChart(col.count() - 1).getTimestamp();
		try {
	...
	public static boolean logVector(Double[] leitura, String name,
			String description, int numberOfSamples, long timestamp) {
		String reading = "";
	...
	public static void saveChartCollection(DBChartCollection chartCollection,
