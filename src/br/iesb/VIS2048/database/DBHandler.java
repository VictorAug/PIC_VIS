...
public class DBHandler {
     ...
     *
     * @param dBFileCollection novo DB file collection
     */
     ...
     * @param mainDBFileName the main db file name
     */
